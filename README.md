...
- Default values now support multi level. so now you can say DateTime.Now , Guid.Now .
- Moving all enums to be located in one class named Types.
- Adding Validation for Max, Min, Not null, Not Empty.
...
- Unified all Exception to throw LightAdo, Unstated of multiple types.
